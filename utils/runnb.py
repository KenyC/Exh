...
# coding: utf-8
"""
Adapted from: https://ogden.eu/run-notebooks
"""
import os
import argparse
import glob
...
parser = argparse.ArgumentParser(
    description = "Runs a set of Jupyter notebooks."
)
...
parser.add_argument(
    '--kernel', 
    help     = "Which IPython kernel to run (default python3).", 
    default  = 'python3', 
    required = False
)
parser.add_argument(
    "-i", '--inplace', 
    help     = "Whether existing notebooks, must be owerwritten (default False).", 
    action   = "store_true"
)
